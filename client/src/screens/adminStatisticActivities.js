...
function StatisticActivities({ navigation }) {
  ...
  console.log(accessUser, newUser)
      ...
      return (
        <div>
          ...
          <div className={clsx(styles.pageContainer)}>
            <AdminSidebar select="statistic-activities" />
            <div className={clsx(styles.pageBody)}>
              <div className={clsx(styles.pageRow)}>
                ...
                <LineGraph
                  ...
                  startDate={startDate}
                  endDate={endDate}
                  lines={[accessUser, newUser]}
                  xAxis={['Số lượng truy cập', 'Số khách hàng tạo mới']}
                  width={width}
                  height={height}
                />
              </div>
...
export default StatisticActivities;
